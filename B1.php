...
$rod=$db->query("insert into Swap (select * from d2) ");
$res10=$db->query("truncate table d2");

$rod1=$db->query("insert into d2 (select * from d1) ");
$res11=$db->query("truncate table d1");
$rod2=$db->query("insert into d1 (select * from Swap) ");
